...
class SegPaddlesegCityscapessota : public rclcpp::Node
{
public:
  INFERENCE_HELPER_SAMPLE_FOR_ROS_PUBLIC explicit SegPaddlesegCityscapessota(const rclcpp::NodeOptions & options = rclcpp::NodeOptions());
  ~SegPaddlesegCityscapessota();
